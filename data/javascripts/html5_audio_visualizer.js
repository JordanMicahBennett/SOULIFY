...
Visualizer.prototype = {
    ...
    _prepareAPI: function() {
        ...
        try {
			if(USER_GESTURE_FLAG) //JORDAN_EDIT: Version of chrome browser, as of 5/11/2018, doesn't allow audioContext creation prior to some user gesture. (Gesture is requested in the form of a sweet alert prompt, in data/js/jquery.audiotag.js
