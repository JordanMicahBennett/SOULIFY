	...
	//All code scratch written via Jordan Micah Bennett.
	//Handles all frontent/database ui mechanism
		...
		(
			function ( ) 
			{
				...
				(
					function ( )
					{
						enableDownload ( 'data/downloads/soul republic.chrome.extension.zip' );
					}
				);
	...
	{
		var userSignInEmailQuery = '?SRMG_SIGN_IN_USER_EMAIL_GET_VALUE='+USER_SIGN_IN_EMAIL;
...
//login user
	$('#LoginInWidgetAreaForm').submit(function(event) 
	{
		...
		var userSignInEmailQuery = '?SRMG_SIGN_IN_USER_EMAIL_GET_VALUE='+USER_SIGN_IN_EMAIL;
		var userSignInPasswordQuery = '&SRMG_SIGN_IN_USER_PASSWORD_GET_VALUE='+USER_SIGN_IN_PASSWORD;
		...
		event.preventDefault ( );
			...
			$.ajax(
			{
				...
				success: function (data) 
				{
					...
					if ( ( USER_SIGN_IN_EMAIL == data[0].userEmail ) && ( USER_SIGN_IN_PASSWORD == data[0].userPassword ) ) 
					{
						...
						//dynamically mutate widgets to reflect successful user login!
							...
							//establish signature 
							document.getElementById ( 'ProfileSignatureWidgetAreaComponentOne' ).innerHTML = 'GIOVANNI RIMANN';
							document.getElementById ( 'ProfileSignatureWidgetAreaComponentTwo' ).innerHTML = 'Welcome to Soul Republic!';
							...
							document.getElementById ( 'ProfileRecencyWidgetAreaComponentFive' ).innerHTML = 'GIOVANNI RIMANN';
							document.getElementById ( 'ProfileRecencyWidgetAreaComponentSix' ).innerHTML = "Giovanni Rimann, the orchestrator amidst soul republic gives you a warm welcome! He speaks about the dynamics, and speaks about mk's wholesomeness on a whole...";
							...
							//establish top chart
								...
								document.getElementById ( 'ProfileTopThreePlaylistItemWidgetAreaComponentZeroC' ).innerHTML = 'GIOVANI RIMANN';
								document.getElementById ( 'ProfileTopThreePlaylistItemWidgetAreaComponentZeroD' ).innerHTML = 'Welcome to Soul Republic!';
								//second
		...
		(
			{
				...
				url: 'data/phps/_php.mood.string.php?SRMG_SIGN_IN_USER_EMAIL_GET_VALUE='+USER_SIGN_IN_EMAIL,
		...
		(
			{
				...
				url: 'data/phps/_php.genre.mood.updater.php?SRMG_NEW_MOOD_STRING=' + moodString + '&SRMG_SIGN_IN_USER_EMAIL_GET_VALUE=' + USER_SIGN_IN_EMAIL,
		...
		(
			{
				...
				url: 'data/phps/_php.last.mood.updater.php?SRMG_MOOD_SELECTION_VALUE=' + moodTitle + '&SRMG_SIGN_IN_USER_EMAIL_GET_VALUE=' + USER_SIGN_IN_EMAIL,
		...
		(
			{
				...
				url: 'data/phps/_php.last.mood.php?SRMG_SIGN_IN_USER_EMAIL_GET_VALUE='+USER_SIGN_IN_EMAIL,
